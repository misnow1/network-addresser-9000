...
_Avoid_: confusing this with Department (ADR 0021) — Department owns a VLAN and is purely descriptive vocabulary nothing branches on; Owner owns equipment and blocks hostname computation when absent; reading `Rack.owner` as inheritance rather than a creation-time default
